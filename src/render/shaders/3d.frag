...
layout(location = 1) smooth in float f_depth;
...
void main() {
    if (!gl_FrontFacing) {
        ...
        vec4 frag_color = vec4(1. - f_depth, 1. - f_depth, 1. - f_depth, 1.0);
        ...
        outColor = frag_color * vec4(ambient_color + diffuse_color, 1.0);
    }
}
